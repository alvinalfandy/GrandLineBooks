...
namespace GrandLineBooks.Controllers
{
    public class AdminController : Controller
    {
        ...
        public async Task<IActionResult> Dashboard()
        {
            ...
            // Get statistics
            ViewBag.TotalBooks = await _mongoDBService.Books.CountDocumentsAsync(_ => true);
        ...
        public async Task<IActionResult> CreateBook(Book book)
        {
            ...
            TempData["Success"] = "Buku berhasil ditambahkan!";
        ...
        [HttpPost]
        public async Task<IActionResult> EditBook(string id, Book book)
        {
            if (!IsAdmin())
                return RedirectToAction("Login", "Account");
            ...
            TempData["Success"] = "Buku berhasil diupdate!";
            return RedirectToAction("Books");
        }
        ...
        public async Task<IActionResult> DeleteBook(string id)
        {
            ...
            TempData["Success"] = "Buku berhasil dihapus!";
            return RedirectToAction("Books");
        }
